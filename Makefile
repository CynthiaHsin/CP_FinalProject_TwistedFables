# gmae engine
GAME_DATA_STATUS := game_data_status.c game_data_status_red_riding_hood.c game_data_status_mulan.c game_data_status_kaguya.c
GAME_DATA := game_data_card.c game_data_player.c game_data_deck.c $(GAME_DATA_STATUS) game_data_map.c game_data.c
GAME_ACTION := game_action.c game_action_basic.c game_action_skill_red_riding_hood.c game_action_skill_mulan.c game_action_skill_kaguya.c
