...
int32_t generate_permutations(int *arr, int32_t n, int *best_card,int *best_card_skill,int *best_card_attack,int *best_card_movement,int32_t *best_card_keep,int32_t player_use,int32_t player_des);
